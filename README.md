...
- ✅ **`/erdettorsdag`** – livets vigtigste spørgsmål. Svarer `:D` + et billede om torsdagen, og `:(` + et andet billede alle andre dage (billederne hentes fra [erdettorsdag.dk](https://erdettorsdag.dk)).
